...
struct perf_branch_stack {
	...
	struct perf_branch_entry	entries[] __counted_by(nr);
};
static_assert(offsetof(struct perf_branch_stack, entries) ==
	      sizeof(struct perf_branch_stack_hdr),
	      "struct member outside of struct_group_tagged()");
