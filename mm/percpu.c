							 ...
							 int map_size)
{
	...
	/* allocate chunk */
	alloc_size = flex_struct_size(chunk, populated,
						      ...
						      int nr_units)
{
	...
	base_size = ALIGN(flex_struct_size(ai, groups, nr_groups),
...
#undef PCPU_SETUP_BUG_ON
	...
	pcpu_chunk_struct_size = flex_struct_size(chunk, populated,
