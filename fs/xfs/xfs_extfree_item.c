...
{
	return struct_size((struct xfs_efi_log_format_32 *)0, efi_extents, n - 1);
}
...
{
	return struct_size((struct xfs_efi_log_format_64 *)0, efi_extents, n - 1);
}
...
{
	return struct_size((struct xfs_efd_log_format_32 *)0, efd_extents, n - 1);
}
...
{
	return struct_size((struct xfs_efd_log_format_64 *)0, efd_extents, n - 1);
}
